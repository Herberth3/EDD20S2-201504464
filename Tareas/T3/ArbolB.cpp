...
bool ArbolB::buscarNodo(Pagina* actual, int cl, int &k)
{
    int index;
    bool encontrado;
...
Pagina* ArbolB::buscar(int cl, int &n)
{
    return buscar( raiz, cl, n);
}

Pagina* ArbolB::buscar(Pagina* actual, int cl, int &n)
{
    if (actual == 0)
    {
        return 0;
...
void ArbolB::insertar(int cl)
{
    raiz = insertar(raiz, cl);
}

Pagina* ArbolB::insertar(Pagina* raiz, int cl)
{
    bool subeArriba;
    int mediana;
    Pagina* nd;
...
bool ArbolB::empujar(Pagina* actual, int cl, int &mediana, Pagina *& nuevo)
{
    int k ;
...
void ArbolB::meterPagina(Pagina* actual, int cl, Pagina *ramaDr, int k)
{
...
void ArbolB::dividirNodo(Pagina* actual, int &mediana, Pagina * &nuevo, int pos)
{
    int i, posMdna, k;
    Pagina *nuevaPag;
    k = pos;
